...
let
  sources = {
    ...
    "caniuse-db-1.0.30000986" = {
      name = "caniuse-db";
      packageName = "caniuse-db";
      version = "1.0.30000986";
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-db/-/caniuse-db-1.0.30000986.tgz";
        sha512 = "8SKJ12AFwG0ReMjPwRH+keFsX/ucw2bi6LC7upeXBvxjgrMqHaTxgYhkRGm+eOwUWvVcqXDgqM7QNlRJMhvXZg==";
      };
    };
    ...
    "electron-to-chromium-1.3.201" = {
      ...
      version = "1.3.201";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.201.tgz";
    ...
    "elm-0.19.0-no-deps" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/elm/-/elm-0.19.0-no-deps.tgz";
        sha512 = "tOlSeo5Bt0Rkrt/aBjL+/a+TmAFdfeqjrOlThrhgKOoGeHt1hU7/hJ+HFMlHiODf09AQh7Anl64o7V6thzmRHw==";
      };
    };
    "elm-hot-1.1.0" = {
      name = "elm-hot";
      ...
      version = "1.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/elm-hot/-/elm-hot-1.1.0.tgz";
        sha512 = "9vA9qE2IcJGNV5N7Ga3FdNs5GKY81ocBbliD2rxJELHnVW4agH95gbpROSoSd43JL8DRmKIQvZ6sX0h+xztTmA==";
      };
    };
    ...
    "elm-webpack-loader-git://github.com/halfzebra/elm-webpack-loader#updated-elm-compiler" = {
      name = "elm-webpack-loader";
      packageName = "elm-webpack-loader";
      version = "6.0.0";
      src = fetchgit {
        url = "git://github.com/halfzebra/elm-webpack-loader";
        rev = "9ca0812c4885985ada19c28c27b841eb0e75c2d6";
        sha256 = "3a3f2404afab937c87477f348008f56252bc043057fa3ed9323c60c349f90d09";
      };
    };
    "elmi-to-json-0.19.0" = {
      name = "elmi-to-json";
    ...
    "html-webpack-plugin-4.0.0-beta.8" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/html-webpack-plugin/-/html-webpack-plugin-4.0.0-beta.8.tgz";
        sha512 = "n5S2hJi3/vioRvEDswZP2WFgZU8TUqFoYIrkg5dt+xDC4TigQEhIcl4Y81Qs2La/EqKWuJZP8+ikbHGVmzQ4Mg==";
      };
    };
    "htmlparser2-3.10.1" = {
      name = "htmlparser2";
...
in
{
  create-elm-app = nodeEnv.buildNodePackage {
    ...
    version = "3.2.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/create-elm-app/-/create-elm-app-3.2.1.tgz";
      sha512 = "IT0qBSN9bl9CoMAXF1FeW3Bh9jsOf8bOgemrgffJjoU9x5MF0TiyZ1cY8ZdDDukNgFZcqdCgFdoLUQea7YJ4GA==";
    };
    dependencies = [
      ...
      sources."caniuse-db-1.0.30000986"
      ...
      sources."electron-to-chromium-1.3.201"
      sources."elliptic-6.5.0"
      sources."elm-0.19.0-bugfix6"
      sources."elm-hot-1.1.0"
      ...
      (sources."elm-webpack-loader-git://github.com/halfzebra/elm-webpack-loader#updated-elm-compiler" // {
        dependencies = [
          sources."elm-0.19.0-no-deps"
        ];
      })
      ...
      sources."html-webpack-plugin-4.0.0-beta.8"

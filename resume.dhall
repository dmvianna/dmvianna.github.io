    ...
    , { employer =
      ...
      , jobs =
          ...
          , { job_title =
            ...
            , story =
                ''
                Bunnings takes safety seriously. The whole leadership team attends regular safety meetings to continuously improve safety in the business. During my tenure in this role, reporting to the Safety Leadership Team was divided in two streams: regular and ‘deep-dive’ reports. The latter, while still being created at regular times of the year, were focused on ad hoc questions they constantly raised.
                I had a very productive relationship with the Group Safety and National Injury Managers, who represented the safety team at these meetings. They kept me busy with interesting research questions that had real value for the business, and worked the communication channels to make sure that our insights had a lasting impact on established practices and drove organisational change. They would give me the organisational context, we would brainstorm potential sources of information and data, and once I had results, we would discuss its meaning and find yet more gaps in our knowledge that needed to be filled. This would lead to a new iteration, until we were able to present a convincing case to the leadership team.
